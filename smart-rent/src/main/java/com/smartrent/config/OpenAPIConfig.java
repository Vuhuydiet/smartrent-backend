...
public class OpenAPIConfig {
    ...
    private Components buildComponents() {
        return new Components()
                ...
                .addSchemas("ApiResponse", new Schema<>()
                        ...
                        .addProperty("code", new Schema<>().type("string").example("999999")
                                .description("Response code (999999 for success, others for errors)"))
                        .addProperty("message", new Schema<>().type("string").nullable(true)
                                .description("Response message"))
                        .addProperty("data", new Schema<>().type("object").nullable(true)
                                .description("Response data payload"))
                )
                .addSchemas("ListingStatusChangeRequest", new Schema<>()
                        .type("object")
                        .description("Request to change listing verification status")
                        .addProperty("verified", new Schema<>().type("boolean").example(true)
                                .description("New verification status for the listing (required)"))
                        .addProperty("reason", new Schema<>().type("string").nullable(true)
    ...
    @Bean
    public GroupedOpenApi adminListingManagementApi(@Value("${open.api.group.package-to-scan}") String packageToScan) {
        return GroupedOpenApi.builder()
                .group("admin-listing-management")
                .displayName("Admin Listing Management")
                .packagesToScan(packageToScan)
                .pathsToMatch("/v1/admin/listings/**")
                .addOpenApiCustomizer(securityCustomizer())
                .build();
    }
