...
public class ListingController {
    ...
    @GetMapping
    @Operation(
        summary = "List listings (legacy - use /search instead)",
        description = "When 'ids' is provided, returns those listings. Otherwise returns a paginated list using 'page' and 'size'. This endpoint is deprecated in favor of /search for better filtering capabilities.",
        parameters = {
