...
> ⚠️ **DEPRECATED — VNPay has been removed.** SmartRent now uses the **SePay Payment Gateway**
> (hosted checkout + IPN) as its payment gateway. This document is kept for historical reference
> only. For the current integration, see **[SEPAY_INTEGRATION_GUIDE.md](./SEPAY_INTEGRATION_GUIDE.md)**.
