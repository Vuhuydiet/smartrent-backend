...
@Schema(description = "Detailed news response with full content and related posts")
public class NewsDetailResponse {
    ...
    @Schema(description = "Related news posts (same category or tags)")
    List<NewsSummaryResponse> relatedNews;
}
