...
public class ListingResponseWithAdmin {
    ...
    @Schema(description = "Whether listing has been disabled by admin")
    Boolean disabled;

    @Schema(description = "When the listing was disabled")
    LocalDateTime disabledAt;

    @Schema(description = "Admin ID who disabled the listing")
    String disabledBy;

    @Schema(description = "Reason for disabling the listing")
