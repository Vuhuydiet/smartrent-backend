...
public class ListingSpecification {
    ...
    public static Specification<Listing> fromFilterRequest(ListingFilterRequest filter) {
        return (root, query, criteriaBuilder) -> {
            ...
            // Disabled filter - exclude disabled listings for public search
            if (filter.getUserId() == null && !Boolean.TRUE.equals(filter.getIsAdminRequest())) {
    ...
    public static Specification<Listing> withinMapBounds(
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            // Exclude disabled listings from map view
            predicates.add(criteriaBuilder.equal(root.get("disabled"), false));
