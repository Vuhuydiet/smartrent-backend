...
public class Listing {
    ...
    // Disabled fields (set when admin resolves a report)
    @Builder.Default
    ...
    // Helper method for disabled status
    public boolean isDisabledListing() {
    ...
    public com.smartrent.enums.ListingStatus computeListingStatus() {
        ...
        // 0. DISABLED - Listing has been disabled by admin
        if (this.disabled != null && this.disabled) {
            return com.smartrent.enums.ListingStatus.DISABLED;
        }
